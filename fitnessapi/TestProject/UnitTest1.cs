...
public class Tests
{
    ...
    public void Setup()
    {
        var options = new DbContextOptionsBuilder<FitnessTrackerDbContext>()
            ...
            _context.FitnessTrackers.AddRange(new List<FitnessTracker.Models.FitnessTracker>
            {
                new FitnessTracker.Models.FitnessTracker { Id = 1, Workout_Date = new DateTime(2023, 4, 20), Steps = 100, Distance_km = 5, CaloriesBurned = 700, HeartRate = 87, SleepDuration = 8.5 },
                new FitnessTracker.Models.FitnessTracker { Id = 2, Workout_Date = new DateTime(2023, 5, 1), Steps = 500, Distance_km = 10, CaloriesBurned = 1000, HeartRate = 77,SleepDuration = 8.5 },
                new FitnessTracker.Models.FitnessTracker { Id = 3, Workout_Date = new DateTime(2023, 5, 1), Steps = 10000, Distance_km = 7, CaloriesBurned = 500, HeartRate = 75, SleepDuration = 8.5 }
            });
    ...
    public async Task GetFitnessTrackers_ReturnsAllEvents()
    {
        ...
        Assert.IsInstanceOf(typeof(List<FitnessTracker.Models.FitnessTracker>), result.Value);
     ...
     [Test]
        ...
        public async Task GetFitnessTracker_ReturnsSingleEvent()
        {
            ...
            Assert.IsInstanceOf(typeof(FitnessTracker.Models.FitnessTracker), result.Value);
        ...
        {
            var testFitnessTracker = new FitnessTracker.Models.FitnessTracker {Id = 4 ,Workout_Date = new DateTime(2023, 7, 1), Steps = 5000, Distance_km = 5, CaloriesBurned = 750, HeartRate = 77, SleepDuration = 8 };
        ...
        {
            var testFitnessTracker = new FitnessTracker.Models.FitnessTracker { Id = 5 ,Workout_Date = new DateTime(2023, 7, 1), Steps = 750, Distance_km = 7, CaloriesBurned = 450, HeartRate = 65, SleepDuration = 7  };
            ...
            var createdFitnessTracker = createdResult.Value as FitnessTracker.Models.FitnessTracker;
        ...
        public async Task PutFitnessTracker_Should_Update_FitnessTracker()
        {
            ...
            var FitnessTracker = new FitnessTracker.Models.FitnessTracker { 
                        Id = 10,
